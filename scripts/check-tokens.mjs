...
const BANNED = [
  /매수하세요/, /매도하세요/, /사세요/, /파세요/, /시그널/, /추천\s*종목/, /추천드립/, /지금\s*사야/,
  // 미장을 붙이며 추가. 레퍼런스로 삼은 Autopilot 은 '따라 사기(copy trading)' 서비스지만
  // 빅보드는 정보 서비스다. 따라 하라는 뉘앙스가 카피에 스며들면 규칙 1 위반이 된다
  /따라\s*사/, /따라\s*투자/, /copy\s*trad/i, /포트폴리오\s*복제/, /그대로\s*담으/,
]
